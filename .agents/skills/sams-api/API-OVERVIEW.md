...
└── Sportsclub  (e.g. Markgräfler Volleys)
...
Leagues belong to a **Season** (`seasonUuid`) and an **Association** (`associationUuid`). Filter by both when looking for Markgräfler Volleys's active leagues:
...
Then scan `leagues/{uuid}/teams` for each league to find Markgräfler Volleys's sportsclub UUID.
...
```json
{
  ...
  "team2Description": "Markgräfler Volleys 1",
  "results": null,
  "_embedded": {
    "team1": { "uuid": "..." },
...
| Sportsclub  | Markgräfler Volleys                                 | `9c8b0252-c19b-4e83-a564-202e90d75c01` |
...
| Team        | Markgräfler Volleys 1 (Herren / Verbandsliga)       | `c2ddea7c-b7ec-4172-aa85-4d9c47aba362` |
| Team        | Markgräfler Volleys 1 (Damen / Bezirksklasse Süd)   | `f41dd752-07b0-42e8-afe2-4662a81eadf9` |
| Team        | Markgräfler Volleys 2 (Damen / Bezirksklasse Mitte) | `88a52416-15f6-4dbc-b5d6-8d38a2bef737` |
