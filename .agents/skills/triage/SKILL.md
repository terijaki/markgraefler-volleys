...
These are canonical role names — the actual label strings used in the issue tracker may differ. If the mapping is missing, ask the user before applying any triage-state labels.
