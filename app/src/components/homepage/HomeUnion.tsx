  ...
  return (
    <Box className="mv-section">
      <Container size="xl" py="xl" px={{ base: "lg", md: "xl" }}>
        <Stack className="mv-card" p="lg" gap="xs">
          ...
          <Text>
            ...
            Müllheim und TV Staufen und beinhaltet aktuell die Herrenmannschaften beider Vereine.
            Auf dieser Webseite erhaltet ihr alle Informationen zu unseren Mannschaften,
