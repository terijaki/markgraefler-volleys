      ...
      <Stack gap="md">
        ...
        <Stack gap="xs" hiddenFrom="sm">
          <Flex justify="space-between" align="flex-start" gap="xs">
            ...
            <Stack gap={0} align="center" style={{ minWidth: 96 }}>
              <Text fw={900} size="3.2rem" c="mvPurple.8" lh={1} style={{ whiteSpace: "nowrap" }}>
                {match.setPointsText}
              </Text>
          ...
          <Flex justify="space-between" align="center" gap="xl">
            <Text
              ...
              fw={500}
              lineClamp={2}
              style={{ flex: 1, minWidth: 0, textWrap: "balance" }}
            >
              {match.team1Name}
            </Text>
        ...
        <Flex justify="space-between" align="flex-start" gap="xs" visibleFrom="sm">
          ...
          <Stack gap={0} align="center" style={{ minWidth: 140 }}>
            <Text fw={900} size="4rem" c="mvPurple.8" lh={1} style={{ whiteSpace: "nowrap" }}>
              {match.setPointsText}
            </Text>
        ...
        {match.setScores.length > 0 && (
          <Stack gap={0} align="center">
            {match.setScores.map((setScore) => {
              ...
              return (
                <SimpleGrid
                  key={`${match.matchUuid}-${setScore.setNumber}`}
                  cols={3}
                  ta="center"
                  spacing="lg"
                >
                  ...
                  <Text c="mvGreen.8" ta="center" fw={700}>
                    ({setScore.setNumber})
                  </Text>
