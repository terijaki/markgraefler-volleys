...
type _CoercedEnvSchema_bf71918a = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_bf71918a> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_bf71918a, 'BRANCH_NAME' | 'VITE_BRANCH_NAME' | 'CDK_ENVIRONMENT' | 'CDK_BUDGET_ALERT_EMAIL' | 'CDK_MONITORING_ALERT_EMAIL' | 'SENTRY_ENVIRONMENT'>> {}
}
...
type _EnvSchemaAsStrings_bf71918a = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_bf71918a {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_bf71918a {}
  }
}